...
public class SimpleGfxGrid implements Grid {
    ...
    public GridPosition makeGridPosition() {
        SimpleGfxGridPosition gridPosition = new SimpleGfxGridPosition((int)(Math.random()*cols), (int)(Math.random()*rows), this,0);
        return gridPosition;
    }
    ...
    public GridPosition makeGridPosition(int col, int row, int type) {
        ...
        SimpleGfxGridPosition gridPosition = new SimpleGfxGridPosition(col, row, this,type);
        return gridPosition;
    }
